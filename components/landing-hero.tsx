    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-8 sm:h-12 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-2 sm:px-4 z-10">
        ...
        <div className="flex-1 flex justify-center">
          <motion.div 
            className="px-1.5 py-0.5 sm:px-3 sm:py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-[8px] sm:text-xs flex items-center gap-1 sm:gap-2"
      ...
      {/* Dashboard Sidebar */}
      <div className="absolute top-8 sm:top-12 left-0 bottom-0 w-10 sm:w-14 bg-slate-50 dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 flex flex-col items-center py-2 sm:py-4 gap-3 sm:gap-6">
        <motion.div 
      ...
      <div className="absolute top-8 sm:top-12 left-10 sm:left-14 right-0 bottom-0 p-1.5 sm:p-2 md:p-4 overflow-hidden">
        <div className="grid grid-cols-3 gap-1 sm:gap-2 md:gap-3 h-full">
          ...
          <div className="col-span-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2 sm:p-3 h-[40%] relative shadow-lg shadow-blue-500/5">
            <div className="flex justify-between items-center mb-1 sm:mb-2">
              ...
              <div className="flex gap-1 sm:gap-2">
                <Badge variant="outline" className="text-[6px] sm:text-[8px] py-0 h-3 sm:h-4">Daily</Badge>
                <Badge variant="outline" className="text-[6px] sm:text-[8px] py-0 h-3 sm:h-4 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-800">Weekly</Badge>
                <Badge variant="outline" className="text-[6px] sm:text-[8px] py-0 h-3 sm:h-4">Monthly</Badge>
              </div>
            </div>
            
            <div className="relative w-full h-[70%]">
              {/* Chart visualization with improved animation and separation */}
              <div className="flex items-end h-full gap-[1px] sm:gap-1.5 px-1 sm:px-3 relative z-10">
                <motion.div 
                  initial={{ height: 0 }}
                  animate={{ height: '60%' }}
          ...
          <div className="rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2 sm:p-3 h-[40%] flex flex-col shadow-lg shadow-blue-500/5">
            ...
            <div className="flex-1 flex flex-col justify-between overflow-hidden">
              <motion.div 
                ...
                className="flex items-center justify-between p-1 sm:p-1.5 border-b border-slate-100 dark:border-slate-700"
              >
                <div className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="text-[7px] sm:text-[9px] font-medium">Conversion Rate</span>
                </div>
              ...
              >
                <div className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="text-[7px] sm:text-[9px] font-medium">Active Users</span>
                </div>
                <div className="flex items-center gap-0.5 sm:gap-1">
              ...
              >
                <div className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="text-[7px] sm:text-[9px] font-medium">Revenue</span>
                </div>
                <div className="flex items-center gap-0.5 sm:gap-1">
          ...
          <div className="col-span-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2 sm:p-3 h-[56%] relative shadow-lg shadow-blue-500/5">
            ...
            <div className="h-[80%] w-full relative pt-1 sm:pt-3">
              <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 450 180">
                ...
                <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4, duration: 0.5 }}>
                  <circle cx="0" cy="60" r="2.5" fill="white" stroke="#3B82F6" strokeWidth="1.25" />
                  <circle cx="150" cy="45" r="2.5" fill="white" stroke="#3B82F6" strokeWidth="1.25" />
                  <circle cx="300" cy="30" r="2.5" fill="white" stroke="#3B82F6" strokeWidth="1.25" />
                  <circle cx="450" cy="15" r="2.5" fill="white" stroke="#3B82F6" strokeWidth="1.25" />
                </motion.g>
              </svg>
            </div>
          </div>
            ...
            <div className="flex-1 flex flex-col gap-1 sm:gap-1.5 overflow-hidden">
              ...
              >
                <div className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="text-[7px] sm:text-[9px] text-blue-800 dark:text-blue-300">CDN</span>
                </div>
